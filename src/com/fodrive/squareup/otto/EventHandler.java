...
class EventHandler
{
     ...
     *
     * @exception IllegalStateException if previously invalidated.
     * @exception java.lang.reflect.InvocationTargetException if the wrapped method throws any {@link Throwable} that is not
